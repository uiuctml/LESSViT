...
class EnMAPTreemapDataset(Dataset):
    """PyTorch dataset for EnMAP-Treemap samples."""

    foreground_classes = [0, 184, 185, 221, 924, 105, 503, 520, 706, 801, 201, 264, 266, 281, 301, 901, 406, 923, 142, 161, 602, 607, 608, 267, 371]
    ...
    def __init__(self, root: str, split: str, transform, gen_task: Optional[str] = None) -> None:
        ...
        """
        self.root = os.path.join(root, "enmap_treemap")
        self.split_file = os.path.join(root, "splits", "enmap_treemap", f"{split}.txt")
        self.split = split
