...
class SpatViT(nn.Module):
    ...
    def forward(self, x):
        ...
        feture3 = feture[2]
        feture4 = feture[1]
        feture1 = upsampling(feture1)
        feture2 = upsampling(feture2)
        feture3 = upsampling(feture3)
        feture4 = upsampling(feture4)
        return feture1,feture2,feture3,feture4
